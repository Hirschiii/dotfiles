...
(setq doom-font (font-spec :family "Source Code Pro" :size 45)
      doom-variable-pitch-font (font-spec :family "Ubuntu" :size 45)
      doom-big-font (font-spec :family "Source Code Pro" :size 72))
(after! doom-themes
